...
let projects = [
  {
    image: 'textures/project-askherout.jpg',
    url: 'https://alokxcoder.github.io/Asking-her-out/',
  },
  {
    image: 'textures/project-brunos.jpg',
    url: 'https://bruno-simon.com/',
  },
  {
    image: 'textures/project-kali.jpg',
    url: 'https://www.kali.org/',
  },
  {
    image: 'textures/project-workingon.jpg',
    url: 'https://albinotonnina.com/',
  },
];
let aboutCameraPos = {
  x: 0.12,
...
function loadIntroText() {
  ...
  loader.load('fonts/unione.json', function (font) {
    ...
    const titleGeo = new TextGeometry('ALOK JAISWAR', {
      font: font,
      size: 0.08,
      height: 0.01,
    });
  ...
  loader.load('fonts/helvatica.json', function (font) {
    ...
    const subTitleGeo = new TextGeometry(
      'Web Designer / UI and UX Developer / Cybersecurity Mastery',
      {
        font: font,
        size: 0.018,
        height: 0,
